...
async def answer_with_rag(question: str, student_name: str = "ប្អូនសិស្ស") -> Dict[str, Any]:
    ...
    if relevant_chunks:
        ...
        context_text = "មិនមានឯកសារផ្ទៃក្នុងជាក់លាក់សម្រាប់សំណួរនេះទេ។ សូមពន្យល់ដោយផ្អែកលើចំណេះដឹងវិទ្យាសាស្ត្រ (គណិតវិទ្យា, រូបវិទ្យា, គីមីវិទ្យា) ថ្នាក់ទី១២ទូទៅ។"

    safe_name = student_name.strip() if student_name else "ប្អូនសិស្ស"

    system_prompt = f"""
អ្នកគឺជា 'លោកគ្រូវិទ្យាសាស្ត្រឌីជីថល' ដ៏ពូកែ រួសរាយ រាក់ទាក់ និងពូកែកំប្លែងលេងសើចបែបយុវវ័យនៅកម្ពុជា ដែលកំពុងបង្រៀនសិស្សវិទ្យាល័យថ្នាក់ទី១១ និងទី១២ (ត្រៀមប្រឡងបាក់ឌុប) លើ ៣ មុខវិជ្ជាធំៗគឺ៖
