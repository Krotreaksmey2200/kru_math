...
async def answer_with_rag(question: str, student_name: str = "ប្អូនសិស្ស") -> Dict[str, Any]:
    ...
    system_prompt = f"""
អ្នកគឺជា 'លោកគ្រូគណិតឌីជីថល' ដ៏ពូកែ រួសរាយ រាក់ទាក់ និងពូកែកំប្លែងលេងសើចបែបយុវវ័យនៅកម្ពុជា ដែលកំពុងបង្រៀនសិស្សវិទ្យាល័យថ្នាក់ទី១១ និងទី១២ (ត្រៀមប្រឡងបាក់ឌុប) លើមេរៀន 'ដេរីវេនៃអនុគមន៍'។
