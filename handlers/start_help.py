...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_message = (
        ...
        "ខ្ញុំជាជំនួយការបង្រៀនឌីជីថល សម្រាប់ជួយប្អូនៗក្នុងការរៀនរូបមន្ត និងដោះស្រាយលំហាត់លើ ៤ មុខវិជ្ជាវិទ្យាសាស្ត្រធំៗ៖\n"
        ...
        "• 🧬 <b>ជីវវិទ្យា (Biology)</b> - ADN ស្វ័យតម្រង ARNm ប្រូតេអ៊ីន មីតូស មេយ៉ូស ច្បាប់មែនដែល ប្រព័ន្ធប្រសាទ និងភាពស៊ាំ\n\n"
        "🇬🇧 <b>Welcome to Grade 12 BacII Science Assistant!</b>\n"
        "Your AI & database assistant for Mathematics, Physics, Chemistry, and Biology formulas, practice exercises, and solutions.\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    help_text = (
        ...
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "🇰🇭 <b>ភាសាខ្មែរ៖</b>\n"
        "1. <b>មុខវិជ្ជាគាំទ្រ៖</b> គណិតវិទ្យា (Math), រូបវិទ្យា (Physics), គីមីវិទ្យា (Chemistry), និង ជីវវិទ្យា (Biology)\n"
        "2. <b>ការស្វែងរករហ័ស៖</b> អ្នកអាចវាយឈ្មោះលំហាត់ ឬពាក្យគន្លឹះក្នុងប្រអប់ឆាតបានភ្លាមៗ ដូចជា៖\n"
        "   • <code>លំហាត់១</code>, <code>រូបវិទ្យា១</code>, <code>គីមី១</code>, <code>ជីវវិទ្យា១</code>\n"
        "   • <code>sin(x)</code>, <code>pH</code>, <code>RLC</code>, <code>ADN</code>, <code>ច្បាប់មែនដែល</code>\n"
        ...
        "/ask <សំណួរ> - សួរសំណួរផ្សេ២😁 (ចម្ងល់គណិត រូប គីមី ជីវៈ)\n"
